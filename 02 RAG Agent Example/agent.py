...
SYSTEM_PROMPT = """Answer question about 'Automobile Statistical Plan Manual Including Facility Association Underwriting Information Plan'.  Use the vector search tool to retrieve context and only use what is returned to formulate your answer.   Be as concise as possible."""
...
VECTOR_SEARCH_TOOLS.append(
        VectorSearchRetrieverTool(
            index_name="benmackenzie_catalog.agent_workshop.gisa_manual_index",
        ...
        for _ in range(max_iter):
            ...
            if tool_calls := last_msg.get("tool_calls", None):
                ...
                for chunk in self.call_llm():
                    if chunk.get("choices") is not None and len(chunk["choices"]) > 0:
